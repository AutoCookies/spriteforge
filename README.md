...
In Phase 1, `compile` performs slicer/trim/pivot processing for PNG spritesheets and returns in-memory atlas sprite metadata. Packer/exporter and file output remain for later phases.
